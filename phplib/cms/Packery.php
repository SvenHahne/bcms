<?php
    ...
    // wrapper klasse für jquery Packery
    class Packery
    {
        protected $pvSize = 0;
        protected $phSize = 0;
        ...
        function loadJs()
        {
            return '<script type="text/javascript" src="'.$GLOBALS['root'].'js/packery.pkgd.min.js"></script>';
        }
        ...
        {        	
            ...
            if ( !$GLOBALS["packeryJInitSet"] )
            {            	 
                $GLOBALS["packeryJInitSet"] = TRUE;
                
                $outStr .= '
                $("#mason-cont").packery({ columnWidth: ".g-sizer", itemSelector: ".item", gutter: ".g-gutter" });
                $("#mason-cont").packery("on", "layoutComplete", function(msnryInstance, laidOutItems) {';
